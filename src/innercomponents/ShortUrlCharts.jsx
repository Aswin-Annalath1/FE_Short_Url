...
const ShortUrlCharts = ({ shortUrlData }) => {
  ...
  return (
    <div className="w-full min-h-max md:h-[250px] mt-20 m-w-[250px] flex md:flex-row flex-col gap-80 justify-around">
      <div className="w-full h-full md:w-2/5 bg-teal-300">
        <Bar
          data={{
      ...
      <div className="w-full h-full md:w-2/5 bg-amber-200">
        <Bar
          data={{
