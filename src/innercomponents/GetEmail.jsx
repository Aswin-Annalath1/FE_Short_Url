...
const GetEmail = ({handleClick, response, setResponse}) => {
  ...
  return (
    <div className="flex flex-col gap-3 sm:m-auto bg-violet-100 bg-opacity-30 hover:bg-opacity-90 justify-center items-center px-3 sm:px-5 rounded-lg shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] pt-3 pb-5 max-w-sm text-center mx-0.5">
      <p className="font-bold text-lg">Forgot Password?</p>
      <p className="text-sm " style={{ color: 'blue' }}>Give your email to rest the Password</p>
      ...
      <button 
      onClick={() => navigate(-1) }
      className="text-black text-sm font-normal p-1 rounded-md hover:bg-slate-400"
      >
        Login ?
      </button>
