...
import GetNewPassword from "../innercomponents/GetNewPassword";
...
const NewPassword = () => {
  ...
  const URL = `${import.meta.env.VITE_API}/reset/${id}/${token}`;
  const updateURL = `${import.meta.env.VITE_API}/reset/update/${id}/${token}`;
